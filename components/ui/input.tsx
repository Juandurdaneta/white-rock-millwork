    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          id={id}
          className={cn(
            "w-full px-4 py-3 bg-neutral-50 border text-primary-900 font-body placeholder:text-neutral-400 focus:outline-none focus:ring-1 transition-colors duration-300",
            error
